...
- **email**: Email portal (akan replace "seputarjabar@gmail.com")
- **socialHandle**: Handle social media (akan replace "seputarjabar")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #1D4ED8 → custom)
  - **dark**: Warna gelap hitam (contoh: #1E3A8A → custom)
...
| `seputarjabar` | `siteName` (tanpa spaces) |
| `seputarjabar` | `socialHandle` |
| `seputarjabar@gmail.com` | `email` |
| `#1D4ED8` (primary) | Warna primary dari config |
| `#1E3A8A` (dark) | Warna dark dari config |
| `#7F2F4F` (secondary) | Warna secondary dari config |
